...
function ContactUs() {
    return (
        <div className="text-center max-w-2xl mx-auto p-10">
            ...
            {/* <div className="mt-8 flex items-center justify-center">
        <h1 className="text-xl font-bold m-2"><MdLocationOn /></h1>
        <div>
          <b>Address:</b>
          ABC Building,First Floor,Gangadgam
          Pune, Maharashtra, 411030
            ...
            <div className="mt-8 flex items-center justify-center">
                ...
                <div>
                    <b>Address:</b> ABC Building, First Floor,
                    <br />
                    Gangadgam Pune, Maharashtra, 411030
                </div>
            </div>
        </div>
    );
