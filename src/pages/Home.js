          ...
          <div style={{ marginRight: '90px' }}>
            ...
            <div className="hover:text-blue-500">
              <div className="flex items-center mt-2">
                <a href="https://g.co/kgs/qx9HNzw" target="_blank">
                  <FaLocationArrow className="hover:text-blue-500 mr-2" style={{ fontSize: "25px" }} />
                </a>
                <h2 className="text-xl">
                  <a href="https://g.co/kgs/qx9HNzw">: UG 05, Raviraj CRU,</a>
                </h2>
              </div>
              <div className="flex items-center">
                <h2 className="text-xl">
                  <a href="https://g.co/kgs/qx9HNzw">Bibwewadi - Kondhawa Rd.,</a>
                </h2>
              </div>
              <div className="flex items-center">
                <h2 className="text-xl">
                  <a href="https://g.co/kgs/qx9HNzw">Pune - 411037</a>
                </h2>
              </div>
            </div>
          </div>
